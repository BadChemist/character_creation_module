...
def defence(char_name: str, char_class: str) -> str:
    """Return the result of the defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return the result of execution of a special perk."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Ask user for the command and execute it."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Ask user to choose a char class of a hero and return it."""
    approve_choice: str = ''
    char_class: str = ''
